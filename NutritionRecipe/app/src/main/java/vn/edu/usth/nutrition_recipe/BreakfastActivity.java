...
public class BreakfastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MenuPopupHelper optionMenu = new MenuPopupHelper(BreakfastActivity.this, menuBuilder, view);
                    ...
                    public boolean onMenuItemSelected(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.item1_in_addfood:
                                startActivity(new Intent(BreakfastActivity.this, TotalBreakfastActivity.class));
                                return true;
                            case R.id.item2_in_addfood:
                                startActivity(new Intent(BreakfastActivity.this, BreakfastListActivity.class));
                                return true;
                            case R.id.item3_in_addfood:
                                startActivity(new Intent(BreakfastActivity.this, CalculatorBreakfastActivity.class));
                                return true;
                            default:
                                return false;
                        }
        ...
        View bt = findViewById(R.id.arrow_breakfast_addfood);
    ...
    private void onClickGoToDetail(Food currentItem) {
        ...
        Intent intent = new Intent(BreakfastActivity.this, BreakfastListActivity.class);
    ...
    private void onClickGoToDetail2(Food currentItem) {
        startActivity(new Intent(BreakfastActivity.this, AlbumActivity.class));
    }
}