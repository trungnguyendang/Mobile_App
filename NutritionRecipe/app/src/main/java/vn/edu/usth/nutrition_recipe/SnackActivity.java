...
public class SnackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MenuPopupHelper optionMenu = new MenuPopupHelper(SnackActivity.this, menuBuilder, view);
                    ...
                    public boolean onMenuItemSelected(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.item1_in_addfood:
                                startActivity(new Intent(SnackActivity.this, TotalSnacksActivity.class));
                                return true;
                            case R.id.item2_in_addfood:
                                startActivity(new Intent(SnackActivity.this, SnacksListActivity.class));
                                return true;
                            case R.id.item3_in_addfood:
                                startActivity(new Intent(SnackActivity.this, CalculatorSnackActivity.class));
                                return true;
                            default:
                                return false;
                        }
        ...
        EditText editText = findViewById(R.id.search_snack);
        ...
        View bt = findViewById(R.id.arrow_snack_addfood);
    ...
    private void onClickGoToDetail(Food currentItem) {
        ...
        Intent intent = new Intent(SnackActivity.this, SnacksListActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("data1snack", currentItem);
        bundle.putSerializable("data2snack", currentItem);
        bundle.putSerializable("data3snack", currentItem);
        bundle.putSerializable("data4snack", currentItem);
        bundle.putSerializable("data5snack", currentItem);
        bundle.putSerializable("data6snack", currentItem);
    ...
    private void onClickGoToDetail2(Food currentItem) {
        startActivity(new Intent(SnackActivity.this, AlbumSnackActivity.class));
    }
}