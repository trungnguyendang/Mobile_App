...
public class LunchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MenuPopupHelper optionMenu = new MenuPopupHelper(LunchActivity.this, menuBuilder, view);
                    ...
                    public boolean onMenuItemSelected(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.item1_in_addfood:
                                startActivity(new Intent(LunchActivity.this, TotalLunchActivity.class));
                                return true;
                            case R.id.item2_in_addfood:
                                startActivity(new Intent(LunchActivity.this, LunchListActivity.class));
                                return true;
                            case R.id.item3_in_addfood:
                                startActivity(new Intent(LunchActivity.this, CalculatorLunchActivity.class));
                                return true;
                            default:
                                return false;
                        }
        ...
        EditText editText = findViewById(R.id.search_lunch);
        ...
        View bt = findViewById(R.id.arrow_lunch_addfood);
    ...
    private void onClickGoToDetail(Food currentItem) {
        ...
        Intent intent = new Intent(LunchActivity.this, LunchListActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("data1lunch", currentItem);
        bundle.putSerializable("data2lunch", currentItem);
        bundle.putSerializable("data3lunch", currentItem);
        bundle.putSerializable("data4lunch", currentItem);
        bundle.putSerializable("data5lunch", currentItem);
        bundle.putSerializable("data6lunch", currentItem);
    ...
    private void onClickGoToDetail2(Food currentItem) {
        startActivity(new Intent(LunchActivity.this, AlbumLunchActivity.class));
    }
}