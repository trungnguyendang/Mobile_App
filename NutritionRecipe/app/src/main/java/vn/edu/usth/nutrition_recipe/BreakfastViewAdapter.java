...
public class BreakfastViewAdapter extends RecyclerView.Adapter<BreakfastViewAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            calo_id = itemView.findViewById(R.id.text_breakfast_calo);
